...
class newjava {
    ...
    public static void main(String[] args) {
        ...
        int x;
        String[] menu_list = {"1 --------- Register.", "2 --------- Login.", "3 --------- Services List.", "4 --------- Select Service.", "5 --------- Search Customer by Number", "6 --------- Search Customer by ID.", "7 --------- Search Customer by Service.", "8 --------- Search Services by Customer."};
